...
function PensDashboard() {
  ...
  if (pens.length === 0) {
    return (
      <AppShell>
        <section className="flex-1 flex flex-col items-center justify-center gap-6 px-6 py-16">
          <div className="max-w-2xl text-center space-y-4">
            <p className="uppercase tracking-[0.4em] text-cyan-400 text-sm">
              Welcome
            </p>
            <h1 className="text-4xl font-bold">
              You don&apos;t have any pens yet
            </h1>
  ...
  return (
    <AppShell>
      <main className="flex-1 bg-slate-950 text-white px-6 py-12">
